...
const CourseWiseInstallmentOutstandingReport = () => {
  const hasMounted = useMounted();

  return (
    <Container fluid className="p-6">
      {/* Page Heading */}
      <PageHeading heading="CourseWise Installment Outstanding Report " />
      <Breadcrumb>
        <Breadcrumb.Item href="#">Academic</Breadcrumb.Item>
        <Breadcrumb.Item href="#">Fees Reports</Breadcrumb.Item>
        <Breadcrumb.Item href="#">Fees Report</Breadcrumb.Item>
        <Breadcrumb.Item active>
          CourseWise Installment Outstanding Report
        </Breadcrumb.Item>
      </Breadcrumb>
...
export default CourseWiseInstallmentOutstandingReport;
